...
def main():
    ...
    process_data(cur, conn, filepath='C:\Data\SourceData\Songs', func=process_song_file)
    process_data(cur, conn, filepath='C:\Data\SourceData\Logs', func=process_log_file)
